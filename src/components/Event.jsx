	...
	render() {
		...
		return (
			<div className="app-content event-content">
				...
				<p><b>Vendor Name: </b> {event.vendorName}</p>
				<p><b>Vendor Address: </b> {event.vendorAddress}</p>
				<p><b>Vendor Status: </b> {event.vendorStatus}</p>
				<p><b>Vendor Services: </b> {event.vendorServices}</p>
