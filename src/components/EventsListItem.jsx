		...
		<div className="row">
			<div className="card blue-grey darken-1">
				<div className="card-content white-text">
					...
					<p>Vendor Address: {props.vendorAddress}</p>
					<p>Vendor Status: {props.vendorStatus}</p>
					<p>Vendor Services: {props.vendorServices}</p>
					<p>Additional Information: {props.message}</p>
				</div>
				<div className="card-action right-align">
					<i onClick={props.removeEvent} className="material-icons delete-event-icon">delete</i>
					<Link to={`/events/${props.id}`} className="event-item-link">Edit Event</Link>
